...
function JoinButton({ className }) {
  return (
    <button
      className={`flex items-center gap-2 rounded-full bg-neutral-900 p-2 text-white duration-500 hover:bg-lime-200 hover:text-black hover:ease-in-out ${className}`}
    >
      Join our team
